...
export default function CategoryBanner({ title, imageSrc, description, link, alt, className, contentClassName }: CategoryBannerProps) {
  ...
  const bannerContent = (
    <>
      ...
      <div className={cn("absolute bottom-0 left-0 right-0 p-4 sm:p-6 md:p-8 lg:p-10 pb-4 sm:pb-6 md:pb-8 lg:pb-10 xl:pb-10", contentClassName)}>
