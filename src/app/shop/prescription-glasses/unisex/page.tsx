...
export default async function PrescriptionGlassesUnisexPage({ searchParams }: { searchParams: Promise<{ [key: string]: string | string[] | undefined }> }) {
    ...
    // Fetch only prescription glasses for UNISEX
    ...
    const bannerTitle = "Unisex Prescription Glasses";
    const bannerDescription = "Versatile styles that look great on everyone.";
    const bannerImage = shopBanner?.imageUrl || "/shopcategory/Unisex.jpg"; // Fallback image
