...
export default function CheckoutPage() {
  ...
  const validateShippingForm = () => {
    ...
    // Validate business fields if business purchase is selected
    if (isBusinessPurchase && !businessForm.businessName.trim()) {
      return "Business name is required for business purchases";
    }
    return null;
  };
                ...
                <div className="lg:col-span-1">
                  <div className="bg-white border border-gray-200 rounded-lg p-6 sticky top-24">
                    ...
                    <Button
                      ...
                      className={`w-full font-semibold py-6 text-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 ${paymentMethod === "paypal"
